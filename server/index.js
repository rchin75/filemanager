...
const {listDirectory, downloadFile, saveFile, createFile, createFolder, deleteFile, uploadFile, renameFile, pasteFile, deleteFiles} = require('./fileSystemActions');
...
app.delete('/api/deleteFiles', isLoggedIn, validatePathExists, deleteFiles);
