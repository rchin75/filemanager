...
const {listDirectory, downloadFile, saveFile, createFile, createFolder, deleteFiles, uploadFile, renameFile, pasteFile} = require('./fileSystemActions');
...
app.delete('/api/delete', isLoggedIn, validatePathExists, deleteFiles);
